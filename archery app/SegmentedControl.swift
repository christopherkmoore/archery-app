...
@IBDesignable class SegmentedControl: UIControl {
    ...
    @IBInspectable var items: [String] = ["Recurve", "Compound"] {
        didSet {
            setupLabels()
        }
    }
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            label.font = UIFont(name: "Roboto Slab Light", size: 15)
    ...
    func displayNewSelectedIndex(){
        ...
        UIView.animateWithDuration(0.5, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.8, options: .TransitionNone, animations: {
